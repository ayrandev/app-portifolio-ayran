...
export default function CardsAbout() {
  ...
  return (
    <section id="About-me" className="relative min-h-screen bg-gradient-to-b from-zinc-950 via-[#000F0C] to-zinc-950 px-4 sm:py-10">
  <GifBackGround />

  <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 pt-8">
    ...
    <div className="text-center w-full min-h-[400px] sm:min-h-[500px] max-w-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-4">
        {[
          ...
          { Icon: <SiTailwindcss className="text-4xl text-teal-400" />, title: "Tailwind", description: "Framework de estilização utilitária." },
        ].map((skill, index) => (
